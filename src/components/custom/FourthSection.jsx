  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl px-4 text-balance">
        Empower your e-commerce journey with our comprehensive resources. Access
        valuable guides, articles, webinars, and templates to optimize your
        online store, drive sales, and stay ahead of the curve.
      </h3>
